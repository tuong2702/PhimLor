...
<body>
	...
	<div class="container" style="margin-top: 8rem;">
		...
		<br> 
		<div class="row">
			<form class="col-6" style="margin: auto;" action="login"
				 method="post">
         <hr>
				<div class="mb-3">
				...
				<div class="mb-3 form-check">
					<label class="form-check-label"><input type="checkbox" name="remember" ${checkRemember}
						class="form-check-input"> Remember password?</label>
				</div>
				<div class="mb-3">
					${message}
				</div>
